...
import { RiArrowDownSLine, RiArrowRightSLine, RiDashboardLine, RiGitRepositoryLine, RiSettings5Line, RiLogoutBoxRFill, 
        RiMenuUnfoldFill, RiCloseLine, RiNotification3Line, RiCheckboxBlankCircleFill, RiSurveyFill, RiFileUserFill} from "react-icons/ri" ;   
import { FcSalesPerformance, FcTodoList, FcAssistant} from "react-icons/fc";
import LOGOA from './assets/Imagenes/LOGOA.mp4';
...
function App() {
  ...
  return (
    <div className="bg-[#4682b4]" >  
      ...
      <div className="flex">
      <sidebar 
      className={`bg-[#104C91] fixed ${showMenu ? "-left-0" : "-left-full" }  lg:left-0 top-0 w-72 h-full p-8 flex flex-col justify-between transition-all z-50`}>
          ...
          <nav >
              ...
              <button className="w-full text-left py-2 px-4 rounded-md shadow-sm" 
               ...
               <a href="#" className="flex items-center gap-4 text-black-400 tracking-[4px] hover:text-gray-200 transition-colors ">
                ...
                {dropdown1Open && (
                  ...
                  style={{position: 'absolute', left: '1505px', top: '-245px', border: "5px double black", borderRight: 'none', borderRadius: "10% 0 0 10%",width: '320px'}}>
              <ul className="py-1" >
            ...
            <div className="relative mb-8">
              <button className="w-full text-left py-2 px-4 rounded-md shadow-sm"
                ...
                {dropdown2Open && (
                  <div className="z-10 w-full mt-2 rounded-md bg-[#1F8AC0] shadow-lg" style={{position: 'absolute', left: '210px', top: '0'}}>
                   <ul className="py-1">
      ...
      >
       ...
       <main className="lg:pl-80">
        <header className=" fixed left-0 top-0 w-full bg-[#1F8AC0] p-8 flex justify-end font-bold border-b border-gray-500 ">
         ...
         <li>
            ...
            <a href="#" className="relative hover:text-gray-200 transition-colors" >
              ...
              <RiCheckboxBlankCircleFill className="text-red-600 text-[9px] absolute top-0 right-[2px] "/>
                ...
                {dropdown5Open && (
                   ...
                   style={{position: 'absolute', left: '-470px', top: '25px', width: '500px', height: '800px', border:'5px solid black', borderRadius:'15px'}}>
              <ul className="py-1" >
                <li >
          ...
          <li>
          <div className="relative" >
          <button className="" onClick={toggleDropdown6}>
            ...
            <RiArrowDownSLine/>
                ...
                {dropdown6Open && (
                  <div className="z-10 w-full mt-2 rounded-md  bg-[#4682b4] shadow-lg" style={{position: 'absolute', left: '25px', top: '20px'}}>
        ...
        <div className="pt-28 centered-text">
           <div style={{fontSize: '100px', fontWeight: 'bold', fontFamily: "Broadway" }} >
            ¡WELCOME!<center><FcAssistant style={{fontSize:'85px'}}/></center>
           </div>
        </div>
      </main>
    </div>
